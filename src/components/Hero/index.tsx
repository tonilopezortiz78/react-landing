          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-sm md:text-base">
                  Unlock your trading potential with our cutting-edge
                  technology. Experience precise insights driven by real-time
                  market data and robust strategies, enhanced by sophisticated
                  orderbook and tape analysis.{" "}
                </p>
